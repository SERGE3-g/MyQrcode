...
function generateQRCode(menuUrl, outputPath) {
    return __awaiter(this, void 0, void 0, function () {
        var qrCodeDataUrl, base64Data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, QRCode.toDataURL(menuUrl)];
                case 1:
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Si è verificato un errore durante la generazione del QR code:', error_1);
                    return [3 /*break*/, 3];
